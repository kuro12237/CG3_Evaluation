...
void GraphicsPipelineManager::Create3dParticlePSOs(SPSO& pso)
{
	...
	pso.Particle3d.Subtruct = CreateParticle3dSubtruct(device, commands, shader.Particle);
	pso.Particle3d.Multiply = CreateParticle3dMultiply(device, commands, shader.Particle);
}
...
SPSOProperty GraphicsPipelineManager::CreateParticle3dSubtruct(ComPtr<ID3D12Device> device, Commands commands, SShaderMode shader)
{
	SPSOProperty ParticlePSO;
...
SPSOProperty GraphicsPipelineManager::CreateParticle3dMultiply(ComPtr<ID3D12Device> device, Commands commands, SShaderMode shader)
{
	SPSOProperty ParticlePSO;
