...
private:
	...
	static SPSOProperty CreateParticle3dSubtruct(ComPtr<ID3D12Device>device, Commands commands, SShaderMode shader);
	static SPSOProperty CreateParticle3dMultiply(ComPtr<ID3D12Device>device, Commands commands, SShaderMode shader);
